...
public class DefaultProjectUpdateService {
    ...
    public void updateProject(Long projectId, Long memberId, ProjectUpdateRequestDto projectUpdateRequestDto) {
...
//        projectImageUpdateService.update(imageList, project.getId());
